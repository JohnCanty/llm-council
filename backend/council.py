...
def is_successful_response(response: Optional[Dict[str, Any]]) -> bool:
    """Return True when a model response contains usable content."""
...
Provide a clear, well-reasoned final answer that represents the council's collective wisdom:"""
    ...
    # Query the chairman model, then fall back to a successful council member if needed.
...
async def _try_fallback_chairmen(
    ...
    """Try models that already succeeded in Stage 1 as chairman fallbacks."""
    fallback_models = [
        result["model"]
        for result in stage1_results
